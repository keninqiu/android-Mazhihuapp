...
public class Kanner extends FrameLayout implements View.OnClickListener {
    private List<Latest.top_stories> topStoriesEntities;
    ...
    public void setTopEntities(List<Latest.top_stories> topEntities) {
    ...
    private void initUI() {
        View view = LayoutInflater.from(context).inflate(R.layout.kankan_layout, this, true);
...
//            iv.setBackgroundResource(R.drawable.loading1);
    ...
    public void onClick(View v) {
        if (mItemClickListener != null) {
            Latest.top_stories entity = topStoriesEntities.get(vp.getCurrentItem() - 1);
